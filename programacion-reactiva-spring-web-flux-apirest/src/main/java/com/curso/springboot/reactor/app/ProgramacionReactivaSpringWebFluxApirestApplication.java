...
public class ProgramacionReactivaSpringWebFluxApirestApplication implements CommandLineRunner {
	...
	private static final Logger log = LoggerFactory.getLogger(ProgramacionReactivaSpringWebFluxApirestApplication.class);
	
	public static void main(String[] args) {
		SpringApplication.run(ProgramacionReactivaSpringWebFluxApirestApplication.class, args);
	}
